...
datos.loc[(datos.clase != 'consistencia') & (datos.clase != 'especifique')] = 'nada'
...
vectorizador = CountVectorizer(input="content",analyzer="word",tokenizer=tokenizar,ngram_range=(1, 2))
...
#guardar modelo
save = 'modelo_primer_filtro.sav'
el_fit = 'vectorizador_fil.sav'
